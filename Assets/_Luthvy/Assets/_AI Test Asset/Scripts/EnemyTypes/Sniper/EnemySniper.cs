...
{
    private TheStateSniper currentState;
    ...
    void Start()
    {
        SwitchState(new IdleStateSniper(this)); // IDLE
    ...
    ///////////////////////////////////////////////////////////////////////
    /// STATE SWITCHER
    public void SwitchState(TheStateSniper newState)
    {
    ...
    public void PermaDeath()
    {
        ...
        SwitchState(new DeadStateSniper(this));
        return;
    }
    public void Spooked()
    {
